...
export default function Home() {
  ...
  return (
    <main>
          ...
          <section id="features" className="w-full py-12 md:py-24 lg:py-28">
            <div className="container px-4 md:px-6">
              ...
              <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-6">
                <div className="flex flex-col items-center lg:col-span-2 shadow-xl relative h-[30rem]">
                  <Image src={coffee} alt="coffee" className="w-full h-full object-cover object-center -z-10 absolute"/>
                  <div className="text-white mt-auto mb-12">
                    <h3 className="text-4xl font-bold mb-4 text-center lg:text-left">Mobile Friendly</h3>
                    <p className="text-center font-bold">
                      Create and send invoices from anywhere using our mobile-friendly interface.
                    </p>
                  </div>
                </div>
                <div className="flex flex-col items-center space-y-2 rounded-lg shadow-xl relative lg:col-span-4">
      ...
      <footer className="bg-[#1d1d1d] p-12 rounded-t-2xl">
      </footer>
    </main>
  );
}
